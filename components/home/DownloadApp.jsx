  ...
  return (
      ...
      <div className="lg:flex lg:flex-col pl-20 leading-10 mr-10">
            <div className=" flex flex-col bg-colorBold rounded-lg">
                  ...
                  <Link className='bg-[#bebef1] mx-4 my-2 w-15 w-100 rounded-lg cursor-pointer text-[#fff] text-center' href="/Authentication/usersignup">Join Now</Link>
                  <Link className='bg-[#ffffff] mx-4 my-2 w-15 w-100 rounded-lg cursor-pointer text-[#423fae] text-center' href="/Authentication/userlogin">Login</Link>
                  </div>
            </div>
